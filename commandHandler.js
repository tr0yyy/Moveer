...
const asmimove = require('./commands/asmimove.js')
...
const fkick = require('./commands/fkick.js')
const ckick = require('./commands/ckick.js')
const zkick = require('./commands/zkick.js')
...
const handleCommand = (command, message, args, rabbitMqChannel) => {
  ...
  if (command === 'fkick') fkick.kick(args, message)
  if (command === 'ckick') ckick.kick(args, message)
  if (command === 'zkick') zkick.kick(args, message)
  if (command === 'cmove') cmove.move(args, message, rabbitMqChannel)
  if (command === 'asmimove') asmimove.move(args, message, rabbitMqChannel)
